...
mArenaMixin.defaultSettings.profile.racialCategories = {
    ["Human"] = true,
    ["Scourge"] = true,
    ["Dwarf"] = true,
    ["NightElf"] = true,
...
function mArenaFrameMixin:FindRacial(event, spellID)
...
function mArenaFrameMixin:UpdateRacial()
...
function mArenaFrameMixin:ResetRacial()
    self.race = nil
